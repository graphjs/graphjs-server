...
class AuthenticationController extends AbstractController
{
 ...
 const PASSWORD_RECOVERY_EXPIRY = 15*60;
    ...
    public function tokenSignup(ServerRequestInterface $request, ResponseInterface $response)
    {
        ...
        $this->actualSignup($request,  $response, $username, $data["email"], $password);
    }
    ...
    public function signup(ServerRequestInterface $request, ResponseInterface $response)
    {
        ...
        $this->actualSignup( $request,  $response, $data["username"], $data["email"], $data["password"]);
    }
    ...
    public function login(ServerRequestInterface $request, ResponseInterface $response)
    {
        ...
        $this->actualLogin($request, $response, $data["username"], $data["password"]);
    ...
    public function tokenLogin(ServerRequestInterface $request, ResponseInterface $response)
    {
        ...
        $this->actualLogin($request, $response, $username, $password);
    ...
    protected function actualLogin(ServerRequestInterface $request, ResponseInterface $response, string $username, string $password): void
    {
        $result = $this->kernel->index()->query(
