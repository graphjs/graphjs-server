...
class AuthenticationController extends AbstractController
{
    ...
    public function signup(Request $request, Response $response, Session $session, Kernel $kernel)
    {
        ...
        $this->actualSignup($kernel, $response, $data["username"], $data["email"], $data["password"]);
    }

    protected function actualSignup(Kernel $kernel, Response $response, string $username, string $email, string $password): void
    {
        try {
            $new_user = new User(
