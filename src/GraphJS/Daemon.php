...
class Daemon extends \Pho\Server\Rest\Daemon
{
    ...
    protected function configureAutoloading()
    {
        ...
        error_log(var_export($composerClassLoader->getPrefixesPsr4()['Pho\\Kernel\\Services\\Index\\Adapters\\'], true));
        error_log(var_export($composerClassLoader->getPrefixesPsr4()['PhoNetworksAutogenerated\\'], true));
    }
